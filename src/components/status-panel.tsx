...
export function StatusPanel({ state, errorMessage }: StatusPanelProps) {
  ...
  return (
    <section className="rounded-xl border border-slate-200 bg-white/60 p-4 shadow-xl shadow-black/10 transition-colors dark:border-white/10 dark:bg-slate-900/60 dark:shadow-black/40">
